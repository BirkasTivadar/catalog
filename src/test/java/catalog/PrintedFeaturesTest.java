...
class PrintedFeaturesTest {
    @Test
    void testCreate() {
        PrintedFeatures audioFeatures = new PrintedFeatures("Harry Potter", 600, List.of("J.K. Rowling", "Someoneelse"));
    ...
    void missingTitle() {
        Exception actualException = assertThrows(IllegalArgumentException.class, () -> {
            new PrintedFeatures("", 600, List.of("J.K. Rowling", "Someoneelse"));
        });
    ...
    void invalidNumberOfPages() {
        assertThrows(IllegalArgumentException.class, () -> {
            new PrintedFeatures("Harry Potter", -1, List.of("J.K. Rowling", "Someoneelse"));
        });
    }
